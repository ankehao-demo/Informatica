"""
create_hhs_migration_stub_tables.py
====================================
Creates stub/test tables in the hhs_migration database for validation
of the EHRP2BIIS_UPDATE pipeline.

Purpose:
  Session 7 (INVOKE - Run EHRP2BIIS_UPDATE Job) failed because the
  pre_load notebook could not find the required tables in hhs_migration.
...
Usage:
  Upload to Databricks workspace and run as a notebook, or execute via:
    databricks workspace import --overwrite --language PYTHON \\
        --file create_hhs_migration_stub_tables.py \\
        /pipelines/EHRP2BIIS_UPDATE/create_hhs_migration_stub_tables
...
def create_spark_session():
    ...
    spark = SparkSession.builder \
        .appName("create_hhs_migration_stub_tables") \
    ...
    data = [
        {
            ...
            "EFFDT": TEST_EFFDT,
            "EFFSEQ": TEST_EFFSEQ,
            "HIRE_DT": date(2020, 3, 15),
            "REHIRE_DT": None,
            "CMPNY_SENIORITY_DT": date(2020, 3, 15),
            "SERVICE_DT": date(2020, 3, 15),
            "TERMINATION_DT": None,
            "BUSINESS_TITLE": "IT Specialist",
            "PROBATION_DT": date(2021, 3, 15),
            "SETID": "HHS01",
            "GVT_SCD_RETIRE": date(2020, 3, 15),
            "GVT_SCD_TSP": date(2020, 3, 15),
            "GVT_SCD_LEO": None,
            "GVT_SCD_SEVPAY": date(2020, 3, 15),
            "GVT_SEVPAY_PRV_WKS": 0,
            "GVT_WGI_STATUS": "E",
            "GVT_WGI_DUE_DATE": date(2027, 3, 15),
            "GVT_TEMP_PRO_EXPIR": None,
            "GVT_SABBATIC_EXPIR": None,
            "GVT_CURR_APT_AUTH1": "ZLM",
            "GVT_CURR_APT_AUTH2": "",
            "GVT_RTND_GRADE_BEG": None,
            "GVT_RTND_GRADE_EXP": None,
            "TEMP_GVT_EFFDT": None,
            "OTH_PAY": 0.0,
            "GVT_CNV_BEGIN_DATE": date(2020, 3, 15),
            "GVT_TEMP_PSN_EXPIR": None,
            "GVT_APPT_LIMIT_DYS": 0,
            "GVT_SPEP": 0,
            "GVT_SUPV_PROB_DT": None,
            "GVT_APPT_EXPIR_DT": None,
            "LAST_INCREASE_DT": date(2025, 3, 15),
            "GVT_COMP_LVL_PERM": "0001",
            "GVT_DETAIL_EXPIRES": None,
            "GVT_TENURE": "1",
        },
        {
            "EMPLID": "T00000002",
            ...
            "EFFDT": TEST_EFFDT,
            "EFFSEQ": 0,
            "HIRE_DT": date(2022, 7, 1),
            "REHIRE_DT": None,
            "CMPNY_SENIORITY_DT": date(2022, 7, 1),
            "SERVICE_DT": date(2022, 7, 1),
            "TERMINATION_DT": None,
            "BUSINESS_TITLE": "Program Analyst",
            "PROBATION_DT": date(2023, 7, 1),
            "SETID": "HHS01",
            "GVT_SCD_RETIRE": date(2022, 7, 1),
            "GVT_SCD_TSP": date(2022, 7, 1),
            "GVT_SCD_LEO": None,
            "GVT_SCD_SEVPAY": date(2022, 7, 1),
            "GVT_SEVPAY_PRV_WKS": 0,
            "GVT_WGI_STATUS": "E",
            "GVT_WGI_DUE_DATE": date(2027, 7, 1),
            "GVT_TEMP_PRO_EXPIR": None,
            "GVT_SABBATIC_EXPIR": None,
            "GVT_CURR_APT_AUTH1": "ZLM",
            "GVT_CURR_APT_AUTH2": "",
            ...
            "TEMP_GVT_EFFDT": None,
            "OTH_PAY": 0.0,
            "GVT_CNV_BEGIN_DATE": date(2022, 7, 1),
            "GVT_TEMP_PSN_EXPIR": None,
            "GVT_APPT_LIMIT_DYS": 0,
            "GVT_SPEP": 0,
            "GVT_SUPV_PROB_DT": None,
            "GVT_APPT_EXPIR_DT": None,
            "LAST_INCREASE_DT": date(2025, 7, 1),
            "GVT_COMP_LVL_PERM": "0002",
            "GVT_DETAIL_EXPIRES": None,
            "GVT_TENURE": "1",
        },
    ]
    ...
    data = [
        {
            ...
            "OTH_HRS": 0.0,
            "GOAL_AMT": 0.0,
            "EARNINGS_END_DT": None,
            "GVT_TANG_BEN_AMT": 0.0,
            "GVT_INTANG_BEN_AMT": 0.0,
            "ERNCD": "",
        },
        {
            "EMPLID": "T00000002",
